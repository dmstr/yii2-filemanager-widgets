    ...
    public function postHandler($query, $request, $files)
    {
        ...
        if (!isset($request['action']) && (isset($_SERVER["CONTENT_TYPE"]) && strpos($_SERVER["CONTENT_TYPE"], 'multipart/form-data') !== false)) {
            ...
            if ($uploaded === true) {
                ...
                $response = $this->simpleErrorResponse($this->translate->upload_failed);
            }
        ...
        switch ($request['action']) {
            case 'list':
                ...
                if (!is_array($list)) {
                    $response = $this->simpleErrorResponse($this->translate->listing_filed);
                } else {
            ...
            case 'rename':
                ...
                if ($renamed === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->file_not_found);
                } else {
                    $response = $this->simpleErrorResponse($this->translate->renaming_failed);
                }
                break;
            ...
            case 'move':
                ...
                if ($moved === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->moving_failed);
                }
                break;
            ...
            case 'copy':
                ...
                if ($copied === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->copying_failed);
                }
                break;
            ...
            case 'remove':
                ...
                if ($removed === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->removing_failed_directory_not_empty);
                } else {
                    $response = $this->simpleErrorResponse($this->translate->removing_failed);
                }
                break;
            ...
            case 'edit':
                ...
                if ($edited !== false) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->saving_failed);
                }
                break;
            ...
            case 'createFolder':
                ...
                if ($created === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->folder_already_exists);
                } else {
                    $response = $this->simpleErrorResponse($this->translate->folder_creation_failed);
                }
                break;
            ...
            case 'changePermissions':
                ...
                if ($changed === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->permissions_change_failed);
                }
                break;
            ...
            case 'compress':
                ...
                if ($compressed === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->compression_failed);
                }
                break;
            ...
            case 'extract':
                ...
                if ($extracted === true) {
                    ...
                    $response = $this->simpleErrorResponse($this->translate->archive_opening_failed);
                } else {
                    $response = $this->simpleErrorResponse($this->translate->extraction_failed);
                }
                break;
            
            default:
                $response = $this->simpleErrorResponse($this->translate->function_not_implemented);
                break;
        }
